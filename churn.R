...
#remove variable from table that are not very significant in churn
...
##Control statement for cross validation 

Control<-trainControl(method="cv",number=10,savePredictions = TRUE,classProbs = TRUE)

#train mmodelRandom Forest with 10 k fold cross validation 
